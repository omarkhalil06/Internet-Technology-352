...
public class Tracker implements Runnable {
	...
	public ArrayList<Peer> peers;		// maps to a list of dictionaries corresponding to peers
	...
	public void sendRequest(String event) {
		...
		String result = announce_URL;
		result += info_hash_string + peer_id_string + port_string + uploaded_string + downloaded_string +
	...
	public ArrayList<Peer> getPeers() {
		...
		this.interval = (Integer) decoded_response.get(KEY_INTERVAL);
		return peers;
	}
